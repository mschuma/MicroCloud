...
public class Constants {
	...
	public static final String DEFAULT_CHILD_SCRIPT_PATH = "../../../diff-resources/Initial Setup/child.py";
	public static final String DEFAULT_PARENT_SCRIPT_PATH = "../../../diff-resources/Initial Setup/parent.py";
